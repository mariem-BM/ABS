...
class GS_Logo_Slider_Integration_Gutenberg {
    ...
    public function enqueue_block_editor_assets() {
        ...
        wp_register_script( 'gs-logo-block', GSL_PLUGIN_URI . '/includes/integrations/assets/gutenberg/gs-logo-gutenberg-widget.min.js', ['wp-blocks', 'wp-editor'], GSL_VERSION );
