...
var j = 1000;
	...
	var output = 	'<li class="wpsm_ac-panel single_color_box" >'+
		...
		'<input type="text" id="colorbox_title[]" name="colorbox_title[]" value="" placeholder="Enter Box Title Here" class="wpsm_ac_label_text">'+
		'<span class="ac_label"l><?php _e("Box Description",wpshopmart_colorbox_text_domain); ?></span>'+
		'<textarea  id="colorbox_desc[]" name="colorbox_desc[]"  placeholder="Enter Box Description Here" class="wpsm_ac_label_text"></textarea>'+
