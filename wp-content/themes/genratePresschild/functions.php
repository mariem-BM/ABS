<?php
/*Ce fichier fait partie degenratePresschild, generatepress child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function genratePresschild_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'genratePresschild_enqueue_child_styles' );
